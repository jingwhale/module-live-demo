...
*  多文件同时上传
*  @version  1.0
*  @module   pool/component-upload/src/uploader/mutiFileUploader
* ----------------------------------------------------------------
*/
NEJ.define([
    ...
    // 样式
    var _seed_css = _e._$pushCSSText('.u-mutiFileUpload{position:relative; display:inline-block;}');
    ...
    _pro.__reset = function(_options){
        ...
        this.__btnClassName = _options.btnClassName;
        this.__btnDisableClassName = _options.btnDisableClassName;

        this.__txt = _options.txt;
        this.__type = _options.type;
        this.__verifyFile = _options.verifyFile;
        // 回调
    ...
    _pro.__createOneUploadUI = function(){
        ...
        var _ui = _fileUploader._$$UploadUI._$allocate({
            parent : _uiWrapNode,
            btnClassName : this.__btnClassName,
            btnDisableClassName : this.__btnDisableClassName,
            type : this.__type,
            txt : this.__txt,
            verifyFile : this.__verifyFile,
    ...
    _pro.__finishOne = function(_index){
        // 销毁
        if(this.__uilist[_index]){
            _fileUploader._$$UploadUI._$recycle(this.__uilist[_index]);
        ...
        if(this.__uilist){
            ...
            for (var i = this.__uilist.length - 1; i >= 0; i--) {
                if(this.__uilist[i]){
                    ...
                    this.__uilist[i] = _fileUploader._$$UploadUI._$recycle(this.__uilist[i]);
