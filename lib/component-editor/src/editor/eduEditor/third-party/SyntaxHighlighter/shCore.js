        ...
        function isIE78(){
            if (typeof(navigator) != 'undefined' && navigator.userAgent && navigator.userAgent.match(/MSIE/)){
                return navigator.userAgent.split(";")[1].toLowerCase().indexOf("msie 7.0")=="-1" &&
                       navigator.userAgent.split(";")[1].toLowerCase().indexOf("msie 8.0")=="-1"?false:true;
            }
            return false;
        }
        var ie78Bool = block.match("^(&nbsp;)*<span(.*)>([\w\W]*)");
        if (isIE78() && !ie78Bool){//ie7将\r和\n 转化成空格了，特殊处理
        ...
        getCodeLinesHtml: function(html, lineNumbers)
        {
            ...
            for (var i = 0; i < lines.length; i++)
            {
                ...
                html += this.getLineHtml(
                    i,
                    lineNumber,
                    (spaces != null ? '<span class="' + brushName + ' spaces">' + spaces + '</span>' : '') + line
                );
            }
