...
NEJ.define( [
     ...
     * }).$inject('#j-parentNode');
     *
     * @class module:pool/component-input/src/base/component.BaseInput
     ...
     * @param {boolean}             [options.data.isRealTime=false]         是否实时校验
     * @param {boolean}             [options.data.blurValidate=true]        是否失焦就检测
     * @param {boolean}             [options.data.clearErrorOnfocus=true]   是否获取焦点时隐藏错误
    ...
    return Component.$extends({
         ...
         *
         * @protected
         * @method module:pool/component-input/src/base/component.BaseInput#config
         * @return {Void}
         */
        config: function () {
            util.extend(this.data, {
                 ...
                 * input输入的内容
                 *
                 * @member {String} module:pool/component-input/src/base/component.BaseInput#value
                 */
                value: '',
                state: 'normal',
                eltIE9: platform._$KERNEL.browser == 'ie' && platform._$KERNEL.version*1 <= 9,
                /**
                 * placeholder的值
                 *
        ...
        onblur: function(){
            ...
            if( this.data.value && this.data.value.replace ){
